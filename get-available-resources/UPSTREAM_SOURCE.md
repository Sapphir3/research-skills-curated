...
- Original skill name: `get-available-resources`
...
- Skill directory Git tree: `ac2578f705e6bd576cca809a2f1c1c27ed157d1e`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/get-available-resources
...
- Distribution name: `get-available-resources`; directory: `get-available-resources`; distribution version: `1.3.0`
...
All 9 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
