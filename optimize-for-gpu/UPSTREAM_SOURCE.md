...
- Original skill name: `optimize-for-gpu`
- Upstream path: `skills/optimize-for-gpu`
- Selected reference: `v2.69.0`
- Fixed commit: `45af7aefb40e0ef12fda62c6f01d1067ea1e1222`
- Skill directory Git tree: `6f43c77628f9907e1675cc502d144c2f8d2810e1`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/optimize-for-gpu
...
- Upstream declared skill version: `1.4`
- Distribution name: `optimize-for-gpu`; directory: `optimize-for-gpu`; distribution version: `1.4.0`
...
All 16 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
