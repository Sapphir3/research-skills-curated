...
- Original skill name: `scientific-visualization`
...
- Skill directory Git tree: `5deaed71e225759277bb94cdaf846f945ea96234`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/scientific-visualization
...
- Distribution name: `scientific-visualization`; directory: `scientific-visualization`; distribution version: `1.2.0`
...
All 18 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
