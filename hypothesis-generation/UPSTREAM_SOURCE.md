...
- Original skill name: `hypothesis-generation`
- Upstream path: `skills/hypothesis-generation`
- Selected reference: `v2.69.0`
- Fixed commit: `45af7aefb40e0ef12fda62c6f01d1067ea1e1222`
- Skill directory Git tree: `2cb0f93a28f065c3451f947e7ae7866c01b372f1`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/hypothesis-generation
...
- Distribution name: `hypothesis-generation`; directory: `hypothesis-generation`; distribution version: `2.2.0`
...
All 27 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
