...
- Original skill name: `scientific-brainstorming`
...
- Skill directory Git tree: `ba62a692badcba0290f66151f53e8fad99361d83`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/scientific-brainstorming
...
- Distribution name: `scientific-brainstorming`; directory: `scientific-brainstorming`; distribution version: `1.2.0`
...
All 10 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
