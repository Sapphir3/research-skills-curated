...
- Original skill name: `uncertainty-and-units`
...
- Source query (or original acquisition for retained snapshots): `2026-09-21T06:37:39.482276+00:00`
...
- Distribution name: `uncertainty-and-units`; directory: `uncertainty-and-units`; distribution version: `1.1.0`
...
Historical distribution: `uncertainty-and-units-curated`. Existing `uncertainty-and-units-curated-v1.1.0` tags/releases remain immutable. Current installations are not migrated by this repository change.

## Preservation and changes

All 14 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
