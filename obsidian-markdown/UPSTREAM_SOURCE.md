...
- Original skill name: `obsidian-markdown`
- Upstream path: `skills/obsidian-markdown`
- Selected reference: `main`
- Fixed commit: `3ccff5338ea700537839b21900aa5358a0402c98`
- Skill directory Git tree: `4723197c6dc59abc29819da87863b1ac20b96095`
- Source: https://github.com/kepano/obsidian-skills/tree/3ccff5338ea700537839b21900aa5358a0402c98/skills/obsidian-markdown
...
- Distribution name: `obsidian-markdown`; directory: `obsidian-markdown`; distribution version: `1.0.0`
...
All 4 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
