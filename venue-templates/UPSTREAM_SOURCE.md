...
- Original skill name: `venue-templates`
- Upstream path: `skills/venue-templates`
- Selected reference: `v2.69.0`
- Fixed commit: `45af7aefb40e0ef12fda62c6f01d1067ea1e1222`
- Skill directory Git tree: `4819bc84abb1db6c6537e0722bdb8be387c38e3b`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/venue-templates
...
- Distribution name: `venue-templates`; directory: `venue-templates`; distribution version: `1.3.0`
...
All 31 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
