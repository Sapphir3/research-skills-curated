...
当前收录以下 **2 项**。本表列出本仓库采用的技能，不是本机全部安装项或运行验证清单。
...
版本核查时间（北京时间，UTC+8）：scientific-writing 为 **2026-09-21 12:00**；peer-review 为 **2026-09-21 12:23**。“最新”是该时点的查询结果，不会自动刷新。
...
仓库维护文档采用 [MIT License](LICENSE)。上游技能的版权归原作者所有，原 MIT 声明完整保留于 [scientific-writing](scientific-writing-curated/LICENSE.md) 和 [peer-review](peer-review-curated/LICENSE.md) 各自目录；本仓库不改变其授权条件。
