...
- Original skill name: `database-lookup`
- Upstream path: `skills/database-lookup`
- Selected reference: `v2.69.0`
- Fixed commit: `45af7aefb40e0ef12fda62c6f01d1067ea1e1222`
- Skill directory Git tree: `fdb92cf1bf19aa09a7662379cf91e8150338994c`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/database-lookup
...
- Upstream declared skill version: `1.6`
- Distribution name: `database-lookup`; directory: `database-lookup`; distribution version: `1.6.0`
...
All 83 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
