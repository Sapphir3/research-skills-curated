...
- Original skill name: `experimental-design`
- Upstream path: `skills/experimental-design`
- Selected reference: `main`
- Fixed commit: `330c8e764435a731eff571e3efdda70b363d0792`
- Skill directory Git tree: `0fe230c326a7ff17c0201c5fd4e99cc593623fe6`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/330c8e764435a731eff571e3efdda70b363d0792/skills/experimental-design
- Source query (or original acquisition for retained snapshots): `2026-09-21T06:22:28.849077+00:00`
...
- Distribution name: `experimental-design`; directory: `experimental-design`; distribution version: `1.2.0`
...
Historical distribution: `experimental-design-curated`. Existing `experimental-design-curated-v1.2.0` tags/releases remain immutable. Current installations are not migrated by this repository change.
