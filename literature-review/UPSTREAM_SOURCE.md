...
- Original skill name: `literature-review`
- Upstream path: `skills/literature-review`
- Selected reference: `v2.69.0`
- Fixed commit: `45af7aefb40e0ef12fda62c6f01d1067ea1e1222`
- Skill directory Git tree: `b0e60768a73848342e1e5834fd51d9212e9fd837`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/literature-review
...
- Upstream declared skill version: `1.8`
- Distribution name: `literature-review`; directory: `literature-review`; distribution version: `1.8.0`
...
All 12 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
