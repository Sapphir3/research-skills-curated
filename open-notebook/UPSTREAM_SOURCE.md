...
- Original skill name: `open-notebook`
- Upstream path: `skills/open-notebook`
- Selected reference: `v2.69.0`
- Fixed commit: `45af7aefb40e0ef12fda62c6f01d1067ea1e1222`
- Skill directory Git tree: `e675dca291029d123be632628e8fb15f8903ce17`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/open-notebook
...
- Distribution name: `open-notebook`; directory: `open-notebook`; distribution version: `1.3.0`
...
All 8 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
