...
- Original skill name: `latex-posters`
- Upstream path: `skills/latex-posters`
- Selected reference: `v2.69.0`
- Fixed commit: `45af7aefb40e0ef12fda62c6f01d1067ea1e1222`
- Skill directory Git tree: `f6686a41bae955a0b2b0fae3db4a9297a91a9325`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/latex-posters
...
- Upstream declared skill version: `1.7`
- Distribution name: `latex-posters`; directory: `latex-posters`; distribution version: `1.7.0`
...
All 17 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
