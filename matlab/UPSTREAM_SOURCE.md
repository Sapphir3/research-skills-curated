...
- Original skill name: `matlab`
- Upstream path: `skills/matlab`
- Selected reference: `v2.69.0`
- Fixed commit: `45af7aefb40e0ef12fda62c6f01d1067ea1e1222`
- Skill directory Git tree: `643808d0d7868f87e7b8028af6e962ca52af2d7f`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/matlab
...
- Distribution name: `matlab`; directory: `matlab`; distribution version: `1.2.0`
...
All 20 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
