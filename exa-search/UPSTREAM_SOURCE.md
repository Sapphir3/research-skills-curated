...
- Original skill name: `exa-search`
- Upstream path: `skills/exa-search`
- Selected reference: `v2.69.0`
- Fixed commit: `45af7aefb40e0ef12fda62c6f01d1067ea1e1222`
- Skill directory Git tree: `c056872cc5e2ed58633d1968356282da645c3323`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/exa-search
...
- Distribution name: `exa-search`; directory: `exa-search`; distribution version: `1.2.0`
...
All 5 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
