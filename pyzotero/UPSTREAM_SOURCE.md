...
- Original skill name: `pyzotero`
- Upstream path: `skills/pyzotero`
- Selected reference: `v2.69.0`
- Fixed commit: `45af7aefb40e0ef12fda62c6f01d1067ea1e1222`
- Skill directory Git tree: `10c323bf01483ccb23055e5852cf13a3439c3462`
- Source: https://github.com/K-Dense-AI/scientific-agent-skills/tree/45af7aefb40e0ef12fda62c6f01d1067ea1e1222/skills/pyzotero
...
- Distribution name: `pyzotero`; directory: `pyzotero`; distribution version: `1.2.0`
...
All 15 upstream skill files are retained, including scripts, references, assets, templates, tests, attribution, and output capabilities. Original package directory names are preserved, including `nature-proposal-writer` (invocation name `researchwrite`), so sibling references retain their original layout.
